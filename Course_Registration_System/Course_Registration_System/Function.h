...
void removeCourseFromList(student& _student, semester& _semester, string yearName);//(task 15) return false in case there's no such course with that ID in list
